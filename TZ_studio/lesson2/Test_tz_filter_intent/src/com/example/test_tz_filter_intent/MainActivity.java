package com.example.test_tz_filter_intent;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	Log.i("STUDIO_INFO", "MainActivity onCreate");
...
public void showLog(View v) {
	// 收集日志 
	String log = getLogFilter("STUDIO_INFO");
	// Toast 显示 日志 
 ...
 * @return 返回日志字符串
 */
private String getLogFilter(String filter) {
	// 组装采集日志命令
