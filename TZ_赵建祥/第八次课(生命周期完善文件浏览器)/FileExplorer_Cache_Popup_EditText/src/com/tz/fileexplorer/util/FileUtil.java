...
public class FileUtil {
	 ...
	 * @return String
	 */
	public static boolean saveFileContent(File file,String code,String textcontent){
		StringBuffer sBuffer = new StringBuffer();
		...
		try {
			...
			// code为上面方法里返回的编码方式
			outputStreamWriter = new OutputStreamWriter(fOutputStream, code);
	 ...
	 * @return String
	 */
	public static boolean saveFileContent(File file,String textcontent){
		StringBuffer sBuffer = new StringBuffer();
		FileOutputStream fOutputStream = null;
		OutputStreamWriter outputStreamWriter = null;
		BufferedWriter out = null;
