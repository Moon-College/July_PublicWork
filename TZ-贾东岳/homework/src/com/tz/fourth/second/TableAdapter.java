...
public class TableAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			viewHolder.field1 = (TextView) convertView.findViewById(R.id.field_1_tv);
			viewHolder.field2 = (TextView) convertView.findViewById(R.id.field_2_tv);
			viewHolder.field3 = (TextView) convertView.findViewById(R.id.field_3_tv);
