...
public class MyAdapter extends RecyclerView.Adapter<FilesHolder> {
    ...
    public void setOnLongClickListener(OnLongClickListener mLongListener){
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (mLongListener!=null){
                    mLongListener.onLongClick(holder.itemView,position);
                }
                return false;
            }
        });
...
class
        FilesHolder extends RecyclerView.ViewHolder {
    public ImageView iv;
    public TextView tv;
