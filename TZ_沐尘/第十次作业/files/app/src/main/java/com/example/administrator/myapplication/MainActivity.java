            ...
            public void onClick(View v) {
                ...
                popupWindow.dismiss();
                    ...
                    if (bean.bitmap==null){
                        ...
                        it.putExtra("source",bean.path.toString());
                        startActivity(it);
                    }else if (bean.name.endsWith("html")||bean.name.endsWith("txt")||bean.name.endsWith("xml")){
                        Intent it = new Intent();
                        it.addCategory(Intent.CATEGORY_DEFAULT);
                        it.setAction(Intent.ACTION_VIEW);
//                        it.setData(Uri.fromFile(bean.path));
                        it.setDataAndType(Uri.fromFile(bean.path),"text/html/xml");
                        startActivity(it);
